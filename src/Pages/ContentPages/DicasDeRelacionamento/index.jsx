...
export default function DicasDeRelacionamentoPage() {
  return (
    <>
      <div className="bg-secondary/60 min-h-screen flex items-center justify-center">
        <div className="w-full max-w-6xl rounded-lg p-2">
          ...
          <div className="flex mt-6 bg-blue/50 rounded-xl">
            <Sidebar />
            <section className="flex-1 bg-blue/40 text-white p-6 rounded-lg shadow-lg ml-6 items-center justify-center" id="dicas-relacionamento">
